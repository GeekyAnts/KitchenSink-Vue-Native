<template>
  <nb-container :style="{backgroundColor: '#fff'}">
        <nb-header>
          ...
          <nb-body>
            <nb-title>Check Box</nb-title>
          </nb-body>
          <nb-right />
        </nb-header>

        <nb-content>
            <nb-list-item button :onPress="toggleSwitch1">
                <nb-checkbox 
                    :checked="checkbox1"
            ...
            <nb-list-item button :onPress="toggleSwitch2">
                <nb-checkbox
                    color="red"
                    :checked="checkbox2"
            ...
            <nb-list-item button :onPress="toggleSwitch3">
                <nb-checkbox 
                    color="green"
                    :checked="checkbox3"
            ...
            <nb-list-item button :onPress="toggleSwitch4">
                <nb-checkbox
                    color="#000"
                    :checked="checkbox4"
...
export default {
  ...
  methods: {
    toggleSwitch1: function() {
      this.checkbox1 = !this.checkbox1;
    },
    toggleSwitch2: function() {
      this.checkbox2 = !this.checkbox2;
    },
    toggleSwitch3: function() {
      this.checkbox3 = !this.checkbox3;
    },
    toggleSwitch4: function() {
